...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asset.power_consumption'
        db.alter_column('ralph_assets_asset', 'power_consumption', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Asset.power_consumption'
        db.alter_column('ralph_assets_asset', 'power_consumption', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'ralph_assets.asset': {
            ...
            'power_consumption': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
