...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asset.sn'
        db.alter_column('ralph_assets_asset', 'sn', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))
        ...
        # Changing field 'AssetModel.manufacturer'
        db.alter_column('ralph_assets_assetmodel', 'manufacturer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_assets.AssetManufacturer'], null=True, on_delete=models.PROTECT))
        # Adding index on 'Warehouse', fields ['name']
        db.create_index('ralph_assets_warehouse', ['name'])

        # Adding unique constraint on 'Warehouse', fields ['name']
        db.create_unique('ralph_assets_warehouse', ['name'])

        # Adding index on 'AssetManufacturer', fields ['name']
        db.create_index('ralph_assets_assetmanufacturer', ['name'])

        # Adding unique constraint on 'AssetManufacturer', fields ['name']
        db.create_unique('ralph_assets_assetmanufacturer', ['name'])

        # Adding field 'OfficeInfo.deleted'
        db.add_column('ralph_assets_officeinfo', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'PartInfo.deleted'
        db.add_column('ralph_assets_partinfo', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'DeviceInfo.deleted'
        db.add_column('ralph_assets_deviceinfo', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'AssetManufacturer', fields ['name']
        db.delete_unique('ralph_assets_assetmanufacturer', ['name'])

        # Removing index on 'AssetManufacturer', fields ['name']
        db.delete_index('ralph_assets_assetmanufacturer', ['name'])

        # Removing unique constraint on 'Warehouse', fields ['name']
        db.delete_unique('ralph_assets_warehouse', ['name'])

        # Removing index on 'Warehouse', fields ['name']
        db.delete_index('ralph_assets_warehouse', ['name'])
        ...
        # Deleting field 'Asset.slots'
        db.delete_column('ralph_assets_asset', 'slots')


        # User chose to not deal with backwards NULL issues for 'Asset.sn'
        raise RuntimeError("Cannot reverse this migration. 'Asset.sn' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AssetModel.manufacturer'
        raise RuntimeError("Cannot reverse this migration. 'AssetModel.manufacturer' and its values cannot be restored.")
        # Deleting field 'OfficeInfo.deleted'
        db.delete_column('ralph_assets_officeinfo', 'deleted')

        # Deleting field 'PartInfo.deleted'
        db.delete_column('ralph_assets_partinfo', 'deleted')

        # Deleting field 'DeviceInfo.deleted'
        db.delete_column('ralph_assets_deviceinfo', 'deleted')
