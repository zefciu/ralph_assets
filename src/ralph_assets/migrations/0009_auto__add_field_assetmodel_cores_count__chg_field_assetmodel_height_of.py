...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetModel.cores_count'
        db.add_column('ralph_assets_assetmodel', 'cores_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


        # Changing field 'AssetModel.height_of_device'
        db.alter_column('ralph_assets_assetmodel', 'height_of_device', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):
        # Deleting field 'AssetModel.cores_count'
        db.delete_column('ralph_assets_assetmodel', 'cores_count')


        # Changing field 'AssetModel.height_of_device'
        db.alter_column('ralph_assets_assetmodel', 'height_of_device', self.gf('django.db.models.fields.IntegerField')())
