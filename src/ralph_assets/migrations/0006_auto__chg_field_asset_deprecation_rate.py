...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ralph_assets_asset', 'deprecation_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Asset.deprecation_rate'
        db.alter_column('ralph_assets_asset', 'deprecation_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))
    ...
    models = {
        ...
        'ralph_assets.asset': {
            ...
            'deprecation_rate': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '3', 'blank': 'True'}),
