...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.purchase_order'
        db.add_column('ralph_assets_asset', 'purchase_order',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.purchase_order'
        db.delete_column('ralph_assets_asset', 'purchase_order')
