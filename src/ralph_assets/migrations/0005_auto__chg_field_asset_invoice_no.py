...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asset.invoice_no'
        db.alter_column('ralph_assets_asset', 'invoice_no', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Asset.invoice_no'
        db.alter_column('ralph_assets_asset', 'invoice_no', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
