...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'ralph_assets.myrelatedtestmodel': {
            'Meta': {'object_name': 'MyRelatedTestModel'},
            'count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'my_test_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ralph_assets.MyTestModel']"})
        },
        'ralph_assets.mytestmodel': {
            'Meta': {'object_name': 'MyTestModel'},
            'field1': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'field2': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
