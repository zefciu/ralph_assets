...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Support', fields ['contract_id']
        db.delete_unique('ralph_assets_support', ['contract_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Support', fields ['contract_id']
        db.create_unique('ralph_assets_support', ['contract_id'])
