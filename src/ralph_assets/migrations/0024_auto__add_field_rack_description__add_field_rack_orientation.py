...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ralph_assets_rack', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Rack.orientation'
        db.add_column('ralph_assets_rack', 'orientation',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('ralph_assets_rack', 'description')

        # Deleting field 'Rack.orientation'
        db.delete_column('ralph_assets_rack', 'orientation')
