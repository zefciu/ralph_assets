...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DataCenter', fields ['deprecated_ralph_dc']
        db.create_unique('ralph_assets_datacenter', ['deprecated_ralph_dc_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataCenter', fields ['deprecated_ralph_dc']
        db.delete_unique('ralph_assets_datacenter', ['deprecated_ralph_dc_id'])
