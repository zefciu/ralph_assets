...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Accessory', fields ['name']
        db.delete_unique('ralph_assets_accessory', ['name'])

        # Removing index on 'Accessory', fields ['name']
        db.delete_index('ralph_assets_accessory', ['name'])


    def backwards(self, orm):
        # Adding index on 'Accessory', fields ['name']
        db.create_index('ralph_assets_accessory', ['name'])

        # Adding unique constraint on 'Accessory', fields ['name']
        db.create_unique('ralph_assets_accessory', ['name'])
