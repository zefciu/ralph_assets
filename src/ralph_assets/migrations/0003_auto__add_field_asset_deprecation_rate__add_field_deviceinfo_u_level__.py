...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.deprecation_rate'
        db.add_column('ralph_assets_asset', 'deprecation_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'DeviceInfo.u_level'
        db.add_column('ralph_assets_deviceinfo', 'u_level',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceInfo.u_height'
        db.add_column('ralph_assets_deviceinfo', 'u_height',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Asset.deprecation_rate'
        db.delete_column('ralph_assets_asset', 'deprecation_rate')

        # Deleting field 'DeviceInfo.u_level'
        db.delete_column('ralph_assets_deviceinfo', 'u_level')

        # Deleting field 'DeviceInfo.u_height'
        db.delete_column('ralph_assets_deviceinfo', 'u_height')

        # Deleting field 'DeviceInfo.rack'
        db.delete_column('ralph_assets_deviceinfo', 'rack')
    ...
    models = {
        ...
        'ralph_assets.asset': {
            ...
            'deprecation_rate': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
