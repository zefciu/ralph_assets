...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accessory.orientation'
        db.add_column('ralph_assets_accessory', 'orientation',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accessory.orientation'
        db.delete_column('ralph_assets_accessory', 'orientation')
