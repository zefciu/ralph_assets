...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetModel.asset_type'
        db.add_column('ralph_assets_assetmodel', 'asset_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetModel.asset_type'
        db.delete_column('ralph_assets_assetmodel', 'asset_type')
