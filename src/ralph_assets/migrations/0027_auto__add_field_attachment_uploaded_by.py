...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.uploaded_by'
        db.add_column('ralph_assets_attachment', 'uploaded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.uploaded_by'
        db.delete_column('ralph_assets_attachment', 'uploaded_by_id')
