...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ralph_assets_transitionshistory', 'uid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))

        # Changing field 'TransitionsHistory.affected_user'
        db.alter_column('ralph_assets_transitionshistory', 'affected_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding field 'Transition.required_report'
        db.add_column('ralph_assets_transition', 'required_report',
