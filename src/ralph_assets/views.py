    ...
    def __init__(self, *args, **kwargs):
        ...
        self.columns = [
            ...
            _('Model', field='model', sort_expression='model', bob_tag=True,
              export=True),
            _('Manufacturer', field='model__manufacturer',
              sort_expression='model__manufacturer', bob_tag=True, export=True,
              show_conditions=show_back_office),
            _('Category', field='model__category',
              sort_expression='model__category', bob_tag=True,
              show_conditions=show_back_office),
            _('User', field='user', sort_expression='user', bob_tag=True,
